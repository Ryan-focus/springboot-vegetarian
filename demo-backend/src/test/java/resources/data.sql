...
-- 食記文章
INSERT INTO post (title, postedDate, postedText, imgurl,postStatus) VALUES
...
喜歡吃韓式燒肉、日本料理的人，拜託你一定要收藏《熟・菜豚屋》，找一天犒賞自己一下來吃吧！','p02','待審核'),
...
可是真得物有所值，打完食記後好想衝去桃園再吃一次啊' ,'p03','待審核'),
...
《一碗豆腐》營業時間從下午開始，一路賣到晚上10點，無論當成下午茶點心，或是宵夜都很不錯呢','p04','通過'),
...
若來到《伯朗大道》騎腳踏車，不妨來《舒食男孩二號店》吃個飯，即使是葷食者也會喜歡的舒食美食','p07','未通過'),
...
想訂購素食外燴的人，也請記得先打電話確認，以免撲空唷','p08','未通過');
