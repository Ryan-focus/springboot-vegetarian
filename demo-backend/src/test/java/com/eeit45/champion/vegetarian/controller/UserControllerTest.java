...
class UserControllerTest {
    ...
    public void register_success() throws Exception {
        ...
        userRegisterRequest.setLoginEmail(("test1@gmail.com"));
    ...
    public void register_invalidEmailFormat() throws Exception {
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
        userRegisterRequest.setLoginEmail("3gd8e7q34l9");
        userRegisterRequest.setPassword("123");
    ...
    public void register_emailAlreadyExist() throws Exception {
        // 先註冊一個帳號
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
        userRegisterRequest.setLoginEmail("test2@gmail.com");
        userRegisterRequest.setPassword("123");
    ...
    public void login_success() throws Exception {
        // 先註冊新帳號
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
        userRegisterRequest.setLoginEmail("test3@gmail.com");
        userRegisterRequest.setPassword("123");
        ...
        userLoginRequest.setLoginEmail(userRegisterRequest.getLoginEmail());
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.userId", notNullValue()))
                .andExpect(jsonPath("$.email", equalTo(userRegisterRequest.getLoginEmail())))
                .andExpect(jsonPath("$.createdDate", notNullValue()))
                .andExpect(jsonPath("$.lastModifiedDate", notNullValue()));
    }
    ...
    public void login_invalidEmailFormat() throws Exception {
        UserLoginRequest userLoginRequest = new UserLoginRequest();
        userLoginRequest.setLoginEmail("hkbudsr324");
    ...
    public void login_emailNotExist() throws Exception {
        UserLoginRequest userLoginRequest = new UserLoginRequest();
        userLoginRequest.setLoginEmail("unknown@gmail.com");
        userLoginRequest.setPassword("123");
    ...
    public void login_wrongPassword() throws Exception {
        // 先註冊新帳號
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
        userRegisterRequest.setLoginEmail("test4@gmail.com");
        userRegisterRequest.setPassword("123");
